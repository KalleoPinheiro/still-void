...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      // Radix renders role="alertdialog" but never aria-modal, so assistive
      // tech was told nothing about the content behind the panel being inert
      // (same gap CLIENT-05 closed for Dialog).
      aria-modal="true"
...
// @still-void/ui/react, same as DialogClose carries no styling opinion.
